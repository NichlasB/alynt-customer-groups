...
<table class="wp-list-table widefat fixed striped" aria-label="<?php esc_attr_e('Existing Groups', 'alynt-customer-groups'); ?>">
    ...
    <tbody>
        <?php foreach ($groups as $group) : ?>
            ...
            <tr<?php if ($is_default) : ?> style="background-color: #f0f6fc;"<?php endif; ?>>
                ...
                <td>
                    <form method="post" style="display:inline;">
                        ...
                        <?php
                        if ($is_default) {
                            submit_button(__('Delete', 'alynt-customer-groups'), 'delete', '', false, array('disabled' => 'disabled', 'title' => __('Cannot delete default group', 'alynt-customer-groups')));
                        } else {
