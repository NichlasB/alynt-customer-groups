...
<div class="wccg-pricing-rules-form">
    ...
    <table class="form-table">
        ...
        <tr>
            ...
            <td>
                <input name="discount_value" type="number" step="0.01" id="discount_value" required>
                <p class="description discount-type-hint fixed"><?php esc_html_e('Enter the fixed discount amount in your store\'s currency.', 'alynt-customer-groups'); ?></p>
                <p class="description discount-type-hint percentage" style="display:none;"><?php esc_html_e('Enter a percentage between 0 and 100.', 'alynt-customer-groups'); ?></p>
            </td>
        </tr>
    </table>
        ...
        <tr>
            <td colspan="2">
                <p class="description">
                    ...
                    <?php printf(esc_html__('Times are based on your site timezone: %s. Leave both fields blank for the rule to be always active.', 'alynt-customer-groups'), '<code>' . esc_html(wp_timezone_string()) . '</code>'); ?>
                </p>
            </td>
        </tr>
    </table>
    ...
    <div class="wccg-selection-section">
        ...
        <select name="product_ids[]" multiple class="wccg-native-select" size="10">
    ...
    <div class="wccg-selection-section">
        ...
        <select name="category_ids[]" multiple class="wccg-native-select" size="10">
