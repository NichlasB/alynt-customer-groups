...
class WCCG_Activator {
    ...
    /**
     * Add the created_at column to the pricing_rules table if it does not exist.
     *
     * @since  1.0.0
     * @return void
     * @throws Exception If the ALTER TABLE statement fails.
     */
    ...
    /**
     * Add the is_active column to the pricing_rules table if it does not exist.
     *
     * @since  1.0.0
     * @return void
     * @throws Exception If the ALTER TABLE statement fails.
    ...
    private static function add_is_active_column() {
        ...
        if (empty($column_exists)) {
            ...
            // Existing rules default to active.
            $wpdb->query(
                "UPDATE {$table_name}
                SET is_active = 1
    ...
    /**
     * Add the sort_order column to the pricing_rules table if it does not exist.
     *
     * @since  1.0.0
     * @return void
     * @throws Exception If the ALTER TABLE statement fails.
    ...
    private static function add_sort_order_column() {
        ...
        if (empty($column_exists)) {
            ...
            // Seed sort_order from rule_id so existing rules have a deterministic order.
            $wpdb->query(
                "UPDATE {$table_name}
    ...
    /**
     * Add start_date and end_date schedule columns to the pricing_rules table if they do not exist.
     *
     * @since  1.1.0
     * @return void
     * @throws Exception If either ALTER TABLE statement fails.
     */
    ...
    /**
     * Backfill NULL created_at values left by pre-1.0 installs.
     *
     * @since  1.0.0
     * @return void
